...
public class AQBlocks {
    ...
    public static final RegistryObject<Block> ANDESITE_AZTEC_BRICKS_36 = simpleBlockWithVars("andesite_aztec_bricks_36", AQCreativeTabs.BLOCKS, AQBlocks.ANDESITE_BRICKS_PROP, BlockTags.MINEABLE_WITH_PICKAXE);
