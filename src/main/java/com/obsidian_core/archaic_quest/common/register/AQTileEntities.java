...
import com.obsidian_core.archaic_quest.common.tile.FoundryTileEntity;
...
public class AQTileEntities {
    ...
    public static final RegistryObject<TileEntityType<FoundryTileEntity>> FOUNDRY = register("foundry", () -> TileEntityType.Builder.of(FoundryTileEntity::new, AQBlocks.FOUNDRY.get()).build(null));
