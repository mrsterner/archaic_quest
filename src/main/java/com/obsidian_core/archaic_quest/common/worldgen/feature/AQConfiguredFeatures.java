...
import net.minecraft.world.world.worldgen.VerticalAnchor;
import net.minecraft.world.world.worldgen.blockpredicates.BlockPredicate;
import net.minecraft.world.world.worldgen.feature.ConfiguredFeature;
import net.minecraft.world.world.worldgen.feature.Feature;
import net.minecraft.world.world.worldgen.feature.WeightedPlacedFeature;
import net.minecraft.world.world.worldgen.feature.configurations.FeatureConfiguration;
import net.minecraft.world.world.worldgen.feature.configurations.OreConfiguration;
import net.minecraft.world.world.worldgen.feature.configurations.RandomFeatureConfiguration;
import net.minecraft.world.world.worldgen.feature.configurations.TreeConfiguration;
import net.minecraft.world.world.worldgen.feature.featuresize.TwoLayersFeatureSize;
import net.minecraft.world.world.worldgen.feature.foliageplacers.MegaJungleFoliagePlacer;
import net.minecraft.world.world.worldgen.feature.stateproviders.BlockStateProvider;
import net.minecraft.world.world.worldgen.feature.treedecorators.LeaveVineDecorator;
import net.minecraft.world.world.worldgen.feature.treedecorators.TrunkVineDecorator;
import net.minecraft.world.world.worldgen.feature.trunkplacers.MegaJungleTrunkPlacer;
import net.minecraft.world.world.worldgen.placement.*;
