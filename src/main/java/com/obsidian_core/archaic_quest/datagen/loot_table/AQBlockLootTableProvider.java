...
import net.minecraft.world.world.block.StairBlock;
import net.minecraft.world.world.storage.loot.LootPool;
import net.minecraft.world.world.storage.loot.LootTable;
import net.minecraft.world.world.storage.loot.entries.LootItem;
import net.minecraft.world.world.storage.loot.functions.ApplyBonusCount;
import net.minecraft.world.world.storage.loot.functions.SetItemCountFunction;
import net.minecraft.world.world.storage.loot.predicates.LootItemBlockStatePropertyCondition;
import net.minecraft.world.world.storage.loot.predicates.LootItemCondition;
import net.minecraft.world.world.storage.loot.providers.number.UniformGenerator;
